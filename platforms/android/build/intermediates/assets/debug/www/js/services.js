angular.module('app.services', [])
        ...
        .factory('sharedCartService', ['$ionicPopup', function ($ionicPopup) {
                ...
                cartObj.cart.increment = function (id) {
                    cartObj.cart[cartObj.cart.find(id)].cart_item_qty = parseInt(cartObj.cart[cartObj.cart.find(id)].cart_item_qty) + 1;
                    cartObj.total_qty += 1;
        ...
        .factory('sharedFilterService', function () {
            ...
            var obj = {};
obj.urls=[];
            obj.str = " https://ea0fa089.ngrok.io/ionic/food_menu.php?till=";
            obj.sort = "";
            obj.search = "";
            obj.category = "";
            obj.ptype = "";
            ...
            obj.getUrls = function (str) {


                obj.till = obj.till + 5;
                obj.str = str+ obj.till; // pass the value to url
                ...
                if (obj.sort != "" && obj.category != "") {
                    ...
                    if (obj.query != 'undefined') {
                        obj.str = obj.str + "&query=" + obj.query;
                    }

                } else if (obj.categorytype != "") {

                    obj.str = obj.str + "&categorytype=" + obj.categorytype;
